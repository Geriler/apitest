...
export const pot: PartDef<Potentiometer> = {
  ...
  prefix: "R",
  pins: 3,
  pinLabels: ["крайний вывод 1", "движок", "крайний вывод 3"],
  ...
  tools: [
    toolFor<Potentiometer>()({
      ...
      hint: () => "Нажмите на отверстие — потенциометр займёт его и два соседних справа: крайний вывод, движок, крайний вывод. R — повернуть, F — перевернуть.",
    }),
  ],
  polar: () => false,
